    ...
    <>
      ...
      <div className='flex justify-center my-3'>
        ...
        <div class="flex-1 block mx-2 max-w-sm p-6 bg-white border border-gray-200 rounded-md shadow">
          ...
          <p class="text-xs text-gray-500">
            Some conference room changes have been made. Please check the updated schedule for details.
          </p>
        </div>
        <div class="flex-1 block mx-2 max-w-sm p-6 bg-white border border-gray-200 rounded-md shadow">
          <h5 class="mb-2 text-2xl font-bold tracking-tight text-black">
            Asian Guest Speaker Talks Postponed
          </h5>
          <p class="text-xs text-gray-500">
            The talks by Asian guest speakers have been postponed. New schedule to be announced soon.
          </p>
        </div>
      </div>
      ...
      <div className='flex justify-center my-3'>
        <div class="flex-1 block mx-2 max-w-sm p-6 bg-white border border-gray-200 rounded-md shadow">
          ...
          <p class="text-xs text-gray-500">
            Please be aware of blocked walking paths in the conference venue due to ongoing maintenance work.
          </p>
        </div>
        <div class="flex-1 block mx-2 max-w-sm p-6 bg-white border border-gray-200 rounded-md shadow">
          <h5 class="mb-2 text-2xl font-bold tracking-tight text-black">
      ...
      <div className='flex justify-center my-3'>
        ...
        <div class="flex-1 block mx-2 max-w-sm p-6 bg-white border border-gray-200 rounded-md shadow">
          ...
          <p class="font-normal text-gray-500">
            Here are announcement 12 contents.
          </p>
        </div>
      </div>
    </>
