...
const Announcement = ({ announcementid, title, description, announcement_posted, announcement_updated, onClick }) => {
  ...
  return (
    ...
    <div className='m-2'>
        <div
            className='flex-1 m-auto h-full max-w-sm bg-white border border-gray-200 rounded-md shadow cursor-pointer transition duration-300 ease-in-out transform hover:scale-105'
            onClick={onClick}
        >
